...
def extract_features(url):
    ...
    features['length_url'] = len(url)  # New feature
    tld = domain.split('.')[-1]
    ...
    features['qty_dot_file'] = count_char(file_path, '.')  # Explicitly defined
    features['qty_hyphen_file'] = count_char(file_path, '-')  # Explicitly defined
